...
while True:
    ...
    Team2TotalSaves = 0
    Team2TotalShots = 0
    Team1Off = int(input("Enter Team 1 Offense Rating on 20-80 scale"))
    Team1Def = int(input("Enter Team 1 Defense Rating on 20-80 scale"))
    Team1Goal = int(input("Enter Team 1 Goalie Rating on 20-80 scale"))
    Team2 = input("Enter Team 2")
    Team2Off = int(input("Enter Team 2 Offense Rating on 20-80 scale"))
    Team2Def = int(input("Enter Team 2 Defense Rating on 20-80 scale"))
    Team2Goal = int(input("Enter Team 2 Goalie Rating on 20-80 scale"))
    ...
    for i in range(Games):
        ...
        #30-20 Defense
        if Team1Off <= 20 and Team2Def <= 30 & Team2Def >= 20:
            aSog = random.randint(15, 32)
            Team1Shots += aSog
            Team1TotalShots += Team1Shots
        elif Team1Off <= 30 & Team1Off > 20 and Team2Def <= 30 & Team2Def >= 20:
            ...
            Team1TotalShots += Team1Shots
        #40-31 Defense
        elif Team1Off <= 20 and Team2Def <= 40 & Team2Def > 30:
            ...
            Team1TotalShots += Team1Shots
        #50-41 Defense
        elif Team1Off <= 20 and Team2Def <= 50 & Team2Def > 40:
            ...
            Team1TotalShots += Team1Shots
        #60-51 Defense
        elif Team1Off <= 20 and Team2Def <= 60 & Team2Def > 50:
            ...
            Team1TotalShots += Team1Shots
        #70-61 Defense
        elif Team1Off <= 20 and Team2Def <= 70 & Team2Def > 60:
            ...
            Team1TotalShots += Team1Shots
        #80-71 Defense
        elif Team1Off <= 20 and Team2Def <= 80 & Team2Def > 70:
            aSog = random.randint(10, 20)
            Team1Shots += aSog
            Team1TotalShots += Team1Shots
        ...
        #Team2 Logic Here
        if Team2Off <= 20 and Team1Def <= 30 & Team1Def >= 20:
            aSog = random.randint(15, 32)
            Team2Shots += aSog
            Team2TotalShots += Team2Shots
        elif Team2Off <= 30 & Team2Off > 20 and Team1Def <= 30 & Team1Def >= 20:
            aSog = random.randint(18, 32)
            Team2Shots += aSog
            Team2TotalShots += Team2Shots
            ...
            Team2TotalShots += Team2Shots
        # 40-31 Defense
        elif Team2Off <= 20 and Team1Def <= 40 & Team1Def > 30:
            aSog = random.randint(13, 28)
            Team2Shots += aSog
            Team2TotalShots += Team2Shots
            ...
            Team2TotalShots += Team2Shots
        # 50-41 Defense
        elif Team2Off <= 20 and Team1Def <= 50 & Team1Def > 40:
            aSog = random.randint(13, 25)
            Team2Shots += aSog
            Team2TotalShots += Team2Shots
            ...
            Team2TotalShots += Team2Shots
        # 60-51 Defense
        elif Team2Off <= 20 and Team1Def <= 60 & Team1Def > 50:
            aSog = random.randint(13, 22)
            Team2Shots += aSog
            Team2TotalShots += Team2Shots
            ...
            Team2TotalShots += Team2Shots
        # 70-61 Defense
        elif Team2Off <= 20 and Team1Def <= 70 & Team1Def > 60:
            aSog = random.randint(13, 20)
            Team2Shots += aSog
            Team2TotalShots += Team2Shots
            ...
            Team2TotalShots += Team2Shots
        # 80-71 Defense
        elif Team2Off <= 20 and Team1Def <= 80 & Team1Def > 70:
            aSog = random.randint(10, 20)
            Team2Shots += aSog
        elif Team2Off <= 30 & Team2Off > 20 and Team1Def <= 80 & Team1Def > 70:
            aSog = random.randint(12, 20)
            Team2Shots += aSog
            Team2TotalShots += Team2Shots
