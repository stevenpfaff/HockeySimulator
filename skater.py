...
flames_players = [
    ...
    Skater("Yegor Sharangovich", 65, 40, 45, 30, 60, role="1st Line"),
    ...
    Skater("Matt Coronato", 40, 55, 45, 35, 45, powerplay=30, role="3rd Line"),
...
knights_players = [
    ...
    Skater("Kaeden Korczak", 40, 70, 65, 60, 45,role="bench", position="defense"),
