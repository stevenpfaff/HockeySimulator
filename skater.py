...
ducks_players = [
    Skater("Leo Carlsson", 50, 30, 60, 60, 70, powerplay=55, role="2nd Line"),
    ...
    Skater("Cutter Gauthier", 20, 60, 60, 50, 60, 50,role="3rd Line"),
    ...
    Skater("Pavel Mintyukov", 60, 40, 70, 30, 80, powerplay=30,penaltykill=50, role="2nd Pair", position="defense"),
...
bruins_players = [
    ...
    Skater("Max Jones", 20, 50, 50, 45, 60,role="4th Line"),
...
flames_players = [
    ...
    Skater("Brayden Pachal", 35, 30, 20, 50, 30, role="bench", position="defense"),
...
hurricanes_players = [
    ...
    Skater("Tyson Jost", 30, 40, 30, 40, 60, role="bench"),
...
bluejackets_players = [
    ...
    Skater("Kent Johnson", 55, 60, 30, 40, 45, powerplay=40, role="4th Line"),
...
redwings_players = [
    ...
    Skater("Marco Kasper", 40, 20, 40, 60, 20, 40,role="3rd Line"),
    ...
    Skater("Simon Edvinsson", 30, 30, 60, 70, 55, penaltykill=50,role="2nd Pair", position="defense"),
...
flyers_players = [
    ...
    Skater("Matvei Michkov", 80, 30, 45, 40, 20, 30,role="2nd Line"),
...
sharks_players = [
    ...
    Skater("Macklin Celebrini", 80, 35, 45, 35, 80, 40,role="1st Line"),
...
leafs_players = [
    ...
    Skater("Bobby McMann", 65, 30, 40, 60, 30,role="4th Line"),
...
utah_players = [
    ...
    Skater("Michael Kesselring", 70, 60, 40, 40, 20,role="3rd Pair", position="defense"),
...
canucks_players = [
    ...
    Skater("Nils Hoglander", 65, 55, 60, 60, 50,role="4th Line"),
    ...
    Skater("Arshdeep Bains",  35, 20, 30, 40, 45,role="4th Line"),
...
knights_players = [
    ...
    Skater("Pavel Dorofeyev", 70, 40, 50, 55, 45, 50,role="3rd Line"),
    ...
    Skater("Kaeden Korczak", 40, 70, 65, 60, 45,role="Depth", position="defense"),
...
capitals_players = [
    ...
    Skater("Rasmus Sandin", 60, 60, 60, 30, 60, 30,role="2nd Pair", position="defense"),
]
