...
ducks_players = [
    ...
    Skater("Robby Fabbri", 60, 30, 40, 30, 40, powerplay=30, role="2nd Line"),
    ...
    Skater("Sam Colangelo", role="bench"),
    Skater("Ross Johnston", 20, 20, 20, 40, 30, role="bench"),
    Skater("Cam Fowler", 55, 50, 50, 50, 60, powerplay=20, penaltykill=20, role="Top Pair", position="defense"),
    Skater("Pavel Mintyukov", 60, 40, 70, 30, 80, powerplay=30,penaltykill=50, role="Top Pair", position="defense"),
    Skater("Olen Zellweger", 60, 35, 30, 30, 80, powerplay=20, role="2nd Pair", position="defense"),
    Skater("Brian Dumoulin", 40, 55, 40, 70, 65, penaltykill=35, role="2nd Pair", position="defense"),
    Skater("Radko Gudas", 50, 50, 55, 80, 30, penaltykill=30, role="3rd Pair", position="defense"),
...
bruins_players = [
    ...
    Skater("Trent Frederic", 60, 55, 60, 50, 30, role="2nd Line"),
    Skater("Morgan Geekie", 55, 60, 50, 30, 45, powerplay=30, role="3rd Line"),
    Skater("John Beecher", 60, 50, 20, 50, 30, penaltykill=35, role="3rd Line"),
    Skater("Mark Kastelic", 40, 30, 45, 60, 30, role="3rd Line"),
    Skater("Matthew Poitras", 50, 35, 55, 55, 80, role="4th Line"),
    Skater("Justin Brazeau", 60, 30, 60, 60, 60, powerplay=40,role="4th Line"),
    Skater("Max Jones", 20, 50, 50, 45, 60,role="bench"),
    ...
    Skater("Nikita Zadorov", 60, 55, 40, 60, 20,role="2nd Pair", position="defense"),
    ...
    Skater("Parker Wotherspoon", 20, 20, 60, 60, 65, penaltykill=65, role="bench", position="defense")
]
...
flames_players = [
    ...
    Skater("Jonathan Huberdeau", 40, 70, 60, 35, 60, powerplay=60, role="1st Line"),
    Skater("Nazem Kadri", 55, 80, 60, 40, 80, powerplay=60,role="1st Line"),
    Skater("Andrei Kuzmenko", 80, 60, 55, 50, 65, powerplay=30, role="2nd Line"),
    Skater("Blake Coleman", 55, 50, 60, 65, 30, powerplay=50, penaltykill=80, role="2nd Line"),
    Skater("Connor Zary", 60, 55, 30, 70, 65, powerplay=30, role="2nd Line"),
    Skater("Yegor Sharangovich", 65, 40, 45, 30, 60, role="3rd Line"),
    Skater("Martin Pospisil", 30, 50, 60, 45, 20, role="3rd Line"),
    ...
    Skater("Justin Kirkland",  role="4th Line"),
    # Skater("Dryden Hunt", 30, 30, 20, 60, role="bench"),
    # Skater("Kevin Rooney", 30, 20, 30, 55, role="bench"),
    ...
    Skater("Rasmus Andersson", 50, 65, 65, 30, 65, powerplay=65, penaltykill=50, role="Top Pair", position="defense"),
    Skater("Kevin Bahl", 40, 35, 30, 60, 20, penaltykill=60,role="2nd Pair", position="defense"),
    ...
    Skater("Brayden Pachal", 35, 30, 20, 50, 30, role="3rd Pair", position="defense"),
...
hurricanes_players = [
    ...
    Skater("Andrei Svechnikov", 50, 65, 80, 45, 20, powerplay=70, role="1st Line"),
    Skater("Seth Jarvis", 60, 50, 60, 80,  60, powerplay=60, penaltykill=30, role="1st Line"),
    Skater("Jesperi Kotkaniemi", 50, 40, 50, 60, 30, powerplay=30, role="2nd Line"),
    Skater("Martin Necas", 60, 65, 60, 30, 60, powerplay=35,  role="2nd Line"),
    Skater("Jesper Fast", 30, 40, 60, 70, 60, penaltykill=80,role="2nd Line"),
    Skater("Jack Drury", 20, 50, 45, 80, 40,role="3rd Line"),
    Skater("Jordan Staal", 30, 30, 50, 80, 40, penaltykill=35, role="3rd Line"),
    Skater("Jack Roslovic", 40, 65, 50, 30, 60, role="3rd Line"),
    Skater("Tyson Jost", 30, 40, 30, 40, 60, role="4th Line"),
    Skater("William Carrier", 40, 45, 70, 80, 45, role="4th Line"),
    Skater("Jordan Martinook", 30, 60, 55, 70, 30, penaltykill=60, role="4th Line"),
    ...
    Skater("Jaccob Slavin", 30, 60, 65, 80, 80, penaltykill=80, role="Top Pair", position="defense"),
    Skater("Dimitry Orlov", 60, 40, 60, 60, 65, penaltykill=50,role="Top Pair", position="defense"),
    Skater("Brent Burns", 70, 60, 70, 55, 50, powerplay=65, penaltykill=55, role= "2nd Pair", position="defense"),
    Skater("Sean Walker", 60, 55, 70, 50, 30, penaltykill=60, role="2nd Pair", position="defense"),
...
blackhawks_players = [
    ...
    Skater("Nick Foligno", 35, 55, 40, 65, 30, powerplay=40, penaltykill=55, role="1st Line"),
    Skater("Teuvo Teravainen", 60, 60, 30, 55, 35, powerplay=60, penaltykill=80, role="1st Line"),
    Skater("Tyler Bertuzzi", 50, 60, 80, 35, 60, powerplay=55, role="2nd Line"),
    Skater("Philip Kurashev", 40, 30, 30, 20, 60, powerplay=20, role="2nd Line"),
    Skater("Taylor Hall", 35, 60, 65, 50, 50, powerplay=45, role="2nd Line"),
    Skater("Jason Dickinson", 55, 30, 30,80, 40, penaltykill=30, role="3rd Line"),
    Skater("Ilya Mikheyev", 55, 60, 50, 60, 70, role="3rd Line"),
    Skater("Joey Anderson", 50, 60, 30, 65, 65, penaltykill=60, role="3rd Line"),
    ...
    Skater("Andreas Athanasiou", 45, 40, 40, 20, 80,role="4th Line"),
    ...
    Skater("Wyatt Kaiser", 30, 20, 30, 60, 40, penaltykill= 35,role="3rd Pair", position="defense"),
...
avalanche_players = [
    ...
    Skater("Josh Manson", 60, 70, 50, 50, 20, penaltykill=60,role="2nd Pair", position="defense"),
    Skater("Oliver Kylington", 60, 30, 60, 30, 50, role="3rd Pair", position="defense"),
...
bluejackets_players = [
    ...
    Skater("Yegor Chinakhov", 60, 40, 40, 70, 50, role="1st Line"),
    Skater("Kirill Marchenko", 70, 35, 40, 55, 60, powerplay=55,role="1st Line"),
    Skater("Sean Monahan", 50, 65, 60, 35, 35, powerplay=60, role="1st Line"),
    Skater("Adam Fantilli", 60, 60, 30, 30, 80, powerplay=40, role="2nd Line"),
    Skater("Cole Sillinger", 30, 50, 40, 30, 30, powerplay=40, penaltykill=35,role="2nd Line"),
    Skater("Kent Johnson", 55, 60, 30, 40, 45, powerplay=40, role="2nd Line"),
    Skater("Dmitri Voronkov", 50, 60, 65, 30, 20, powerplay=50, role="3rd Line"),
    Skater("Mikael Pyyhtia", 20, 50, 20, 30, 60, penaltykill=35, role="3rd Line"),
    ...
    Skater("Justin Danforth", 50, 35, 60, 60, 60, penaltykill=30, role="4th Line"),
    ...
    Skater("Damon Severson", 60, 60, 80, 55, 30, powerplay=35, penaltykill=60,role="Top Pair", position="defense"),
    ...
    Skater("Jake Christansen", 20, 60, 35, 40, 60,role="3rd Pair", position="defense")
]

stars_players = [
    Skater("Jason Robertson", 80, 70, 80, 80, 50, powerplay=60, role="1st Line"),
    Skater("Roope Hintz", 80, 65, 70, 60, 60, powerplay=70, penaltykill=70,role="1st Line"),
    Skater("Wyatt Johnston", 65, 60, 60, 55, 40, role="1st Line"),
    Skater("Jamie Benn", 60, 60, 70, 30, 40, powerplay=60,role="2nd Line"),
    Skater("Logan Stankoven", 40, 65, 65, 60, 80, powerplay=55,role="2nd Line"),
    Skater("Matt Duchene", 65, 65, 60, 20,45, powerplay=60, role="2nd Line"),
    Skater("Tyler Seguin", 65, 50, 70, 30, 40, powerplay=50, penaltykill=60,role="3rd Line"),
    ...
    Skater("Nils Lundkvist", 45, 50, 50, 30, 45,role="3rd Pair", position="defense"),
    Skater("Brendan Smith", 50, 20, 30, 50, 35, penaltykill=70,role="bench", position="defense")
]

redwings_players = [
    Skater("Dylan Larkin", 70, 70, 70, 55, 60, powerplay=65, penaltykill=40,role="1st Line"),
    Skater("Lucas Raymond", 65, 50, 50, 40, 80, powerplay=60,role="1st Line"),
    Skater("Alex DeBrincat", 60, 60, 65, 30, 70, powerplay=70,role="1st Line"),
    ...
    Skater("Vladimir Tarasenko", 65, 60, 60, 20, 60,role="2nd Line"),
    ...
    Skater("Jonatan Berggren", 60, 40, 45, 40, 60, powerplay=35,role="4th Line"),
    ...
    Skater("Justin Holl", 30, 35, 45, 50, 35, penaltykill=50,role="3rd Pair", position="defense"),
    Skater("Albert Johansson", role="3rd Pair", position="defense"),
]
...
oilers_players = [
    ...
    Skater("Jeff Skinner", 65, 70, 80, 20, powerplay=60,role="2nd Line"),
    Skater("Viktor Arvidsson", 50, 50, 65, 45, 60, powerplay=50, role="2nd Line"),
    Skater("Adam Henrique", 60, 45, 60, 45, 40, powerplay=60, penaltykill=30, role="2nd Line"),
    Skater("Connor Brown", 20, 50, 50, 50, 60, penaltykill=50,role="3rd Line"),
    ...
    Skater("Evan Bouchard", 70, 60, 80, 50, 60, powerplay=70,role="Number 1", position="defense"),
    ...
    Skater("Travis Dermott", 40, 20, 45, 50, 50, penaltykill=50,role="3rd Pair", position="defense"),
    Skater("Josh Brown", 40, 30, 40, 30, 35, penaltykill=35,role="bench", position="defense")
]

panthers_players = [
    Skater("Matthew Tkachuk", 50, 80, 80, 35, 70, 80,role="1st Line"),
    ...
    Skater("Evan Rodrigues", 20, 50, 65, 80, 60, 55,role="2nd Line"),
    Skater("Eetu Luostarainen", 40, 40, 60, 70, 60, penaltykill=50,role="3rd Line"),
    Skater("Jonah Gadjovich", 20, 30, 45, 40, 40, role="3rd Line"),
    ...
    Skater("Dimitry Kulikov", 30,60, 40, 40, 50, penaltykill=30,role="2nd Pair", position="defense"),
    ...
    Skater("Uvis Balinskis", 35, 30, 30, 40, 60,role="3rd Pair", position="defense"),
...
kings_players = [
    ...
    Skater("Quinton Byfield", 30, 65, 60, 70, 30, 45,role="2nd Line"),
    Skater("Phillip Danault", 60, 55, 60, 60, 50,55,45,role="2nd Line"),
    Skater("Arthur Kaliyev", 35, 50, 60, 45, 35, 40,role="2nd Line"),
    Skater("Trevor Moore", 55, 60, 55, 70, 60, 40, 60,role="3rd Line"),
    Skater("Alexis Lafferiere", 60, 35, 40, 30, 40,role="3rd Line"),
    Skater("Warren Foegle", 30, 60, 80, 55, 50,role="3rd Line"),
    ...
    Skater("Mikey Anderson", 30, 35, 20, 70, 80, penaltykill=45,role="Top Pair", position="defense"),
    Skater("Vladislav Gavrikov", 40, 50, 60, 55, 40, penaltykill=65,role="Top Pair", position="defense"),
    Skater("Jordan Spence", 40, 65, 60, 35, 60, 50,role="2nd Pair", position="defense"),
    Skater("Joel Edmundson", 50, 30, 55, 30, 35, penaltykill=30,role="2nd Pair", position="defense"),
    Skater("Kyle Burroughs", 35, 30, 45, 55, 35, role="3rd Pair", position="defense"),
    Skater("Brandt Clarke", 60, 80, 70, 30, 35, 40,role="3rd Pair", position="defense"),
    Skater("Drew Doughty", 65, 50, 55, 80, 55, 45, 50,role="3rd Pair", position="defense"),
    Skater("Andreas Englund", 35, 30, 30, 60, 60,role="bench", position="defense"),
...
wild_players = [
    ...
    Skater("Marcus Johansson", 45, 45, 55, 55, 65, 55,role="2nd Line"),
    Skater("Ryan Hartman", 60, 60, 60, 35, 45, 50,role="3rd Line"),
    Skater("Marcus Foligno", 60, 50, 60, 80, 40, penaltykill=55,role="3rd Line"),
    ...
    Skater("Jon Merrill", 50, 50, 20, 55, 30,role="3rd Pair", position="defense")
]

canadiens_players = [
    Skater("Nick Suzuki", 70, 60, 55, 45, 65, 60,role="1st Line"),
    Skater("Cole Caufield", 70, 40, 60, 20, 70, 20,role="1st Line"),
    Skater("Juraj Slafkovsky", 55, 30, 55, 40, 20, 30,role="1st Line"),
    Skater("Kriby Dach", 50, 30, 35, 35, 45, 50,role="2nd Line"),
    Skater("Brendan Gallagher", 20, 55, 60, 40, 45,20,role="3rd Line"),
    ...
    Skater("Christian Dvorak", 35, 35, 35, 20, 50, penaltykill=20, role="4th Line"),
    Skater("Joshua Roy", 50, 60, 60, 60, 55,role="4th Line"),
    Skater("Michael Pezzetta", 45, 55, 30, 45, 20,role="bench"),
    Skater("Lane Hutson", 30, 80, 45, 35, 30, 60,role="Top Pair", position="defense"),
    Skater("Mike Matheson", 65, 70, 45,45, 60, 30,30,role="Top Pair", position="defense"),
    ...
    Skater("Arber Xhekaj", 50, 50, 35, 30, 20,role="3rd Pair", position="defense")
]
...
predators_players = [
    ...
    Skater("Tommy Novak", 65, 55, 65, 20, 65, 60,role="3rd Line"),
    Skater("Colton Sissons", 30, 40, 55, 40, 40, 35, 20,role="3rd Line"),
    Skater("Luke Evangelista", 50, 70, 60, 40, 70, 40,role="3rd Line"),
    ...
    Skater("Juuso Parssinen", 30, 30, 45, 35, 70, 35,role="bench"),
    Skater("Roman Josi", 80, 80, 80, 40, 60, 70,role="Number 1", position="defense"),
    Skater("Brady Skjei", 80, 60, 40, 55, 40, penaltykill=45, role="Top Pair", position="defense"),
    Skater("Alexandre Carrier", 30, 40, 50, 60, 50, penaltykill=60,role="2nd Pair", position="defense"),
    Skater("Jeremy Lauzon", 40, 20, 45, 50, 35, penaltykill=30, role="2nd Pair", position="defense"),
    Skater("Dante Fabbro", 35, 55, 50, 55, 40, penaltykill=60,role="3rd Pair", position="defense"),
    Skater("Luke Schenn", 50, 55, 30, 40, 20, penaltykill=40,role="3rd Pair", position="defense"),
    Skater("Marc Del Gaizo", 20, 50, 50, 60, 50,role="3rd Pair", position="defense"),
...
devils_players = [
    ...
    Skater("Erik Haula", 40, 60, 55, 70, 20, 30, 55,role="2nd Line"),
    Skater("Ondrej Palat", 50, 60, 65, 70, 55, 20,role="3rd Line"),
    Skater("Tomas Tatar", 50, 35, 60, 60, 45,role="3rd Line"),
    Skater("Stefan Noesen", 20, 60, 65, 55, 40, 65,role="3rd Line"),
    ...
    Skater("Dougie Hamilton", 80, 60, 80, 30, 20, 60,role="Top Pair", position="defense"),
    Skater("Jonas Siegenthaler", 30, 35, 20, 80, 60, penaltykill=55, role="Top Pair", position="defense"),
...
islanders_players = [
    ...
    Skater("Hudson Fasching", 50, 55, 50, 60, 55, role="bench"),
    Skater("Julien Gauthier", 50, 30, 35, 30, 60,role="bench"),
    Skater("Pierre Engvall", 50, 50, 65, 70, 30, 30,role="4th Line"),
    ...
    Skater("Mike Reilly", 35, 60, 60, 60, 30, 50,role="3rd Pair", position="defense"),
    Skater("Samuel Bolduc", 55, 20, 40, 35, 50,role="bench", position="defense")
]
...
rangers_players = [
    ...
    Skater("Reilly Smith", 50, 65, 55, 50, 50, 60,role="2nd Line"),
    ...
    Skater("K'Andre Miller", 60, 45, 40, 60, 50, penaltykill=80,role="Top Pair", position="defense"),
    ...
    Skater("Braden Schneider", 60, 40, 45, 45, 60, penaltykill=60,role="2nd Pair", position="defense"),
    Skater("Zachary Jones", 55, 40, 35, 30, 50,role="3rd Pair", position="defense"),
    Skater("Chad Ruhwedel", 35, 20, 40, 60, 60, penaltykill=65,role="bench", position="defense")
]

senators_players = [
    Skater("Tim Stuetzle", 60, 60, 60, 40, 80, 55,role="1st Line"),
    ...
    Skater("Josh Norris", 80, 30, 30, 40, 70, 50,role="2nd Line"),
    Skater("Shane Pinto", 30, 35, 55, 70, 55, 50,role="3rd Line"),
    Skater("Ridley Greig", 50, 60, 65, 60, 20, penaltykill=50,role="3rd Line"),
    Skater("David Perron", 60, 55, 45, 55, 30, 60,role="3rd Line"),
    Skater("Michael Amadio", 60, 40, 50, 65, 60,role="3rd Line"),
    ...
    Skater("Jacob Bernard-Docker", 45, 30, 20, 55, 40, penaltykill=45,role="3rd Pair", position="defense")
]

flyers_players = [
    Skater("Travis Konecny", 60, 70, 70, 20, 60, 50, 35,role="1st Line"),
    Skater("Owen Tippett", 60, 60, 70, 35, 60, 60,role="1st Line"),
    Skater("Matvei Michkov", 60, 60, 60, 30, 30, 30,role="1st Line"),
    Skater("Joel Farabee", 60, 60, 60, 30, 60, 20,role="2nd Line"),
    Skater("Tyson Foerster", 50, 20, 50, 80, 60, 55,role="2nd Line"),
    Skater("Morgan Frost", 30, 60, 60, 60, 50, 40,role="2nd Line"),
    Skater("Sean Couturier", 20, 50, 60, 70, 50, 40,70,role="3rd Line"),
    ...
    Skater("Nick Seeler", 35, 50, 50, 60, 60, penaltykill=60,role="2nd Pair", position="defense"),
    Skater("Jamie Drysdale", 45, 40, 30, 20, 70, 60,role="3rd Pair", position="defense"),
    Skater("Erik Johnson", 50, 30, 55, 30, 55, penaltykill=30,role="3rd Pair", position="defense"),
    Skater("Rasmus Ristolainen", 20, 30, 60, 65, 55, penaltykill=60,role="3rd Pair", position="defense"),
    Skater("Egor Zamula", 60, 40, 20, 50, 35, 50,role="3rd Pair", position="defense"),
]
...
penguins_players = [
    ...
    Skater("Michael Bunting", 45, 70, 60, 30, 65, 30,role="2nd Line"),
    Skater("Drew O'Connor", 35, 40, 55, 35, 45, penaltykill=80,role="3rd Line"),
    Skater("Lars Eller", 45, 40, 40, 70, 35, 30, 60,role="2nd Line"),
    Skater("Kevin Hayes", 50, 55, 55, 40, 60, 30,role="4th Line"),
    Skater("Cody Glass", 20, 30, 30, 60, 50, 50,role="4th Line"),
    Skater("Noel Acciari", 30, 20, 45, 60, 60, penaltykill=45,role="4th Line"),
    Skater("Blake Lizotte", 40, 60, 45, 60, 55, penaltykill=60,role="bench"),
    Skater("Anthony Beauvilier", 20, 45, 40, 30, 50,role="3rd Line"),
    Skater("Jesse Puljujarvi", 20, 40, 50, 60, 30,role="4th Line"),
    Skater("Erik Karlsson", 80, 80, 80, 20, 80, 80,role="Number 1", position="defense"),
    Skater("Kris Letang", 70, 60, 60, 30, 50, 55, 80,role="Top Pair", position="defense"),
    Skater("Marcus Pettersson", 30, 70, 70, 60, 45, penaltykill=70, role="2nd Pair", position="defense"),
    Skater("Ryan Graves", 60, 35, 60, 45, 60, penaltykill=60,role="2nd Pair", position="defense"),
...
sharks_players = [
    Skater("William Eklund", 30, 50, 50, 55, 60,role="1st Line"),
    Skater("Tyler Toffoli", 65, 50, 70, 50, 60, 60,role="1st Line"),
    Skater("Mikael Granlund", 30, 45, 60, 20, 60, 50, 20,role="1st Line"),
    ...
    Skater("Cody Ceci", 40, 40, 35, 40, 60, penaltykill=30,role="Top Pair", position="defense"),
    Skater("Jake Walman", 65, 30, 60, 55, 55, penaltykill=50,role="Top Pair", position="defense"),
...
kraken_players = [
    Skater("Chandler Stephenson", 55, 70, 30, 30, 60, 50, 30,role="1st Line"),
    Skater("Jordan Eberle", 60, 70, 80, 40, 40, 60,role="2nd Line"),
    Skater("Matty Beniers", 60, 55, 20, 80, 80, 20,role="2nd Line"),
    Skater("Andre Burakovsky", 60, 60, 50, 30, 55, 30,role="2nd Line"),
    Skater("Jared McCann", 80, 65, 60, 55, 80, 65, 45,role="2nd Line"),
    Skater("Jaden Schwartz", 30, 50, 50, 65, 50, 30,role="2nd Line"),
    Skater("Oliver Bjorkstrand", 55, 55, 60, 50, 65, 50,role="2nd Line"),
    Skater("Yanni Gourde", 35, 60, 60, 55, 45,role="3rd Line"),
    Skater("Eeli Tolvanen", 60, 45, 30, 60, 40, 55,role="3rd Line"),
    Skater("Brandon Tanev", 35, 40, 30, 60, 65, penaltykill=50,role="3rd Line"),
    Skater("Shane Wright", 70, 20, 65, 50, 70, 30,role="4th Line"),
    ...
    Skater("Adam Larsson", 55, 50, 30, 45, 35, penaltykill=20,role="2nd Pair", position="defense"),
    ...
    Skater("Ryker Evans", 50, 55, 30, 80, 50, 45,role="3rd Pair", position="defense"),
    Skater("Josh Mahura", 40, 60, 35, 50, 60,role="3rd Pair", position="defense")
]

blues_players = [
    Skater("Robert Thomas", 65, 80, 70, 35, 50, 40, 45,role="1st Line"),
    Skater("Jordan Kyrou", 80, 70, 60, 50, 60, 45,role="1st Line"),
    Skater("Pavel Buchnevich", 70, 65, 70, 65, 40, 50, 60,role="1st Line"),
    Skater("Brayden Schenn", 60, 60, 35, 30, 40, 50,role="2nd Line"),
    Skater("Jake Neighbours", 65, 30, 40, 35, 55, 40,role="2nd Line"),
    Skater("Brandon Saad", 65, 50, 60, 30, 50, 40,role="2nd Line"),
    Skater("Dylan Holloway", 40, 20, 45, 55, 50,role="3rd Line"),
    Skater("Mathieu Joseph", 30, 65, 45, 55, 70, penaltykill=70, role="3rd Line"),
    Skater("Kasperi Kapanen", 50, 60, 45, 35, 50, penaltykill=40,role="3rd Line"),
    Skater("Radek Faksa", 35, 40, 20, 70, 30, penaltykill=40,role="4th Line"),
    Skater("Alexey Toropchenko", 55, 30, 30, 55, 55, penaltykill=50,role="4th Line"),
    Skater("Alexandre Texier", 55, 50, 45, 30, 35, penaltykill=30, role="4th Line"),
    ...
    Skater("Colton Parayko", 60, 35, 20, 70, 70, penaltykill=40, role="Top Pair", position="defense"),
    Skater("Justin Faulk", 65, 65, 45, 30, 45, 40, 60,role="Top Pair", position="defense"),
    Skater("Nick Leddy", 30, 60, 55, 30, 70, penaltykill=30,role="2nd Pair", position="defense"),
    Skater("Philip Broberg", 50, 55, 55, 45, 55, role="2nd Pair", position="defense"),
    Skater("Ryan Suter", 35, 40, 45, 60, 40, penaltykill=60,role="3rd Pair", position="defense"),
    Skater("Scott Perunovich", 20, 70, 50, 40, 30, 60,role="3rd Pair", position="defense"),
    Skater("Matthew Kessel", 40, 30, 30, 50, 40, role="3rd Pair", position="defense"),
    Skater("Pierre-Olivier Joseph", 55, 60, 65, 30, 40,role="bench", position="defense"),
...
leafs_players = [
    ...
    Skater("Nicholas Robertson", 65, 50, 40, 50, 60,role="3rd Line"),
    Skater("Pontus Holmberg", 55, 65, 35, 60, 55, penaltykill=30,role="3rd Line"),
    ...
    Skater("Calle Jarnkrok", 60, 45, 50, 50, 60, 35, 40,role="bench"),
    ...
    Skater("Jake McCabe", 50, 60, 60, 60, 55, penaltykill=65,role="2nd Pair", position="defense"),
...
utah_players = [
    ...
    Skater("Barrett Hayton", 35, 30, 65, 70, 70,60,role="1st Line"),
    Skater("Nick Schmaltz", 65, 80, 65, 40, 60, 55,role="1st Line"),
    Skater("Logan Cooley", 55, 55, 50, 45, 80, 30,role="2nd Line"),
    Skater("Dylan Guenther", 70, 40, 35, 35, 30, 40,role="2nd Line"),
    Skater("Alex Kerfoot", 30, 65, 35, 60, 60, 35, 45,role="2nd Line"),
    Skater("Josh Doan", 70, 30, 65, 70, 55,role="3rd Line"),
    Skater("Lawson Crouse", 60, 50, 60, 45, 40, 30, 30,role="3rd Line"),
    Skater("Matias Maccelli", 50, 60, 60, 50, 50, 30,role="4th Line"),
    Skater("Nick Bjugstad", 60, 35, 60, 45, 30, 45, 20,role="4th Line"),
    ...
    Skater("Michael Carcone", 70, 30, 50, 30, 40,role="bench"),
    ...
    Skater("Michael Kesselring", 70, 60, 40, 40, 20,role="2nd Pair", position="defense"),
    Skater("Robert Bortuzzo", 30, 20, 45, 45, 20,role="3rd Pair", position="defense"),
    Skater("Olli Maatta", 55, 45, 30, 70, 60,role="3rd Pair", position="defense"),
    Skater("Vladislav Kolyachonok", 65, 80, 60, 50, 40,role="3rd Pair", position="defense"),
    Skater("Sean Durzi", 55, 50, 50, 45, 45, 70, 60,role="bench", position="defense"),
    Skater("John Marino", 30, 60, 30, 65, 70, penaltykill=45,role="bench", position="defense"),
]

canucks_players = [
    Skater("Elias Pettersson", 70, 80, 65, 60, 80, 70, 40,role="1st Line"),
    Skater("JT Miller", 70, 65, 60, 50, 45, 70, 30,role="1st Line"),
    Skater("Brock Boeser", 60, 60, 40, 30, role="1st Line"),
    Skater("Jake DeBrusk", 60, 45, 70, 60, 60, 60, 60,role="2nd Line"),
    Skater("Conor Garland", 60, 65, 60, 80, 80, 30,role="2nd Line"),
    Skater("Nils Hoglander", 65, 55, 60, 60, 50,role="2nd Line"),
    ...
    Skater("Kieffer Sherwood", 60, 55, 45, 50, 30,role="4th Line"),
    ...
    Skater("Quinn Hughes", 70, 70, 70, 60, 70, 80,role="Number 1", position="defense"),
    Skater("Filip Hronek", 45, 60, 40, 40, 60, 60, 60,role="Top Pair", position="defense"),
    Skater("Carson Soucy", 60, 30, 30, 60, 30, penaltykill=55,role="2nd Pair", position="defense"),
    Skater("Tyler Myers", 30, 60, 45, 45, 20, penaltykill=30,role="2nd Pair", position="defense"),
    Skater("Derek Forbort", 60, 45, 30, 60, 50, penaltykill=80,role="3rd Pair", position="defense"),
    Skater("Vincent Desharnais", 40, 40, 45, 55, 30, penaltykill=80,role="3rd Pair", position="defense"),
    Skater("Noah Juulsen", 30, 40, 30, 50, 40, penaltykill=70,role="3rd Pair", position="defense"),
    Skater("Erik Brannstrom", 20, 55, 70, 60, 40, penaltykill=40,role="3rd Pair", position="defense")
]

knights_players = [
    Skater("Jack Eichel", 70, 60, 60, 80, 80, 45, 30,role="1st Line"),
    Skater("Mark Stone", 60, 70, 80, 80, 60, 60, 60,role="1st Line"),
    Skater("Tomas Hertl", 50, 60, 65, 35, 45, 60, 45,role="2nd Line"),
    Skater("William Karlsson", 45, 60, 65, 70, 70,role="2nd Line"),
    Skater("Ivan Barbashev", 60, 60, 60, 20, 55, 30,role="2nd Line"),
    Skater("Victor Olofsson", 65, 35, 30, 30, 60, 50,role="3rd Line"),
    Skater("Brett Howden", 40, 40, 35, 35, 35, penaltykill=45,role="3rd Line"),
    Skater("Alexander Holtz", 60, 50, 40, 30, 35, 30, role="3rd Line"),
    Skater("Pavel Dorofeyev", 70, 40, 55, 60, 50, 45,role="3rd Line"),
    ...
    Skater("Jonas Rondbjerg", 20, 45, 20, 65, 45,role="bench"),
    Skater("Nicolas Roy", 35, 60, 55, 60, 30, 50, 50,role="3rd Line"),
    ...
    Skater("Noah Hanafin", 60, 60, 70, 40, 60, 50,45,role="2nd Pair", position="defense"),
    ...
    Skater("Kaeden Korczak", 40, 70, 65, 60, 45,role="3rd Pair", position="defense"),
...
capitals_players = [
    ...
    Skater("Tom Wilson", 60, 40, 50, 65, 40, 60, 50,role="1st Line"),
    Skater("Dylan Strome", 65, 60, 70, 60, 35, 45,role="1st Line"),
    Skater("Pierre-Luc Dubois", 30, 60, 70, 40, 55,70,role="2nd Line"),
    Skater("Connor McMichael", 50, 50, 50, 35, 35, 30, 45,role="2nd Line"),
    Skater("Nic Dowd", 60, 50, 45, 70, 35, penaltykill=50, role="2nd Line"),
    Skater("Sonny Milano", 50, 50, 60, 65, 40,role="3rd Line"),
    Skater("Aliaksi Protas", 30, 55, 55, 60, 50,role="3rd Line"),
    Skater("Andrew Mangiapane", 55, 60, 70, 50, 45, 45,role="3rd Line"),
    Skater("Brandon Duhaime", 35, 35, 60, 40, 45, penaltykill=50,role="3rd Line"),
    ...
    Skater("Trevor Van Riemsdyk", 30, 45, 55, 80, 70, penaltykill=55,role="2nd Pair", position="defense"),
    Skater("Rasmus Sandin", 60, 60, 60, 30, 60, 30,role="3rd Pair", position="defense"),
]

jets_players = [
    Skater("Kyle Connor", 80, 50, 60, 30, 60, 60,role="1st Line"),
    Skater("Mark Scheifele", 70, 60, 65, 20, 80, 65,role="1st Line"),
    Skater("Gabriel Vilardi", 70, 50, 50, 50, 80, 60,role="1st Line"),
    Skater("Nikolai Ehlers", 65, 80, 80, 40, 80, 60,role="2nd Line"),
    Skater("Adam Lowry", 30, 40, 65, 80, 50, penaltykill=30,role="2nd Line"),
    Skater("Nino Niederreiter", 60, 45, 60, 60, 60, 20,role="2nd Line"),
    ...
    Skater("Dylan DeMelo", 40, 60, 20, 70, 50, penaltykill=35,role="Top Pair", position="defense"),
    Skater("Neal Pionk", 50, 55, 40, 30, 50, 30, 45,role="2nd Pair", position="defense"),
    Skater("Dylan Samberg", 50, 50, 55, 60, 50, penaltykill=70, role="2nd Pair", position="defense"),
    Skater("Logan Stanley", 40, 30, 45, 35, 20, penaltykill=55,role="3rd Pair", position="defense"),
