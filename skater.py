...
ducks_players = [
    ...
    Skater("Cutter Gauthier", 30, 60, 60, 45, 50, 50,role="3rd Line"),
...
hurricanes_players = [
    Skater("Sebastian Aho", 70, 70, 80, 50, 60, powerplay=60, penaltykill=80, role="1st Line"),
    ...
    Skater("Jesperi Kotkaniemi", 50, 40, 40, 55, 30, powerplay=30, role="4th Line"),
    Skater("Martin Necas", 60, 70, 60, 30, 60, powerplay=35,  role="2nd Line"),
    Skater("Jesper Fast", 30, 40, 60, 70, 60, penaltykill=80,role="4th Line"),
    Skater("Jack Drury", 20, 50, 40, 70, 40,role="4th Line"),
    Skater("Jordan Staal", 35, 30, 50, 80, 40, penaltykill=35, role="3rd Line"),
    Skater("Jack Roslovic", 60, 65, 45, 30, 60, role="3rd Line"),
    Skater("Tyson Jost", 30, 40, 30, 40, 60, role="Depth"),
    Skater("William Carrier", 40, 45, 70, 80, 45, role="4th Line"),
    Skater("Jordan Martinook", 30, 60, 60, 70, 30, penaltykill=60, role="3rd Line"),
    ...
    Skater("Jaccob Slavin", 30, 60, 65, 70, 80, penaltykill=80, role="2nd Pair", position="defense"),
    Skater("Dimitry Orlov", 60, 40, 60, 60, 65, penaltykill=50,role="3rd Pair", position="defense"),
    Skater("Brent Burns", 70, 60, 65, 45, 50, powerplay=65, penaltykill=55, role= "2nd Pair", position="defense"),
    Skater("Sean Walker", 60, 55, 70, 45, 30, penaltykill=60, role="3rd Pair", position="defense"),
    Skater("Shayne Gostisbehere", 80, 60, 60, 50, 80, powerplay=60, role="3rd Pair", position="defense"),
    Skater("Jalen Chatfield", 60, 40, 60, 65, 30, role="3rd Pair", position="defense")
]
...
bluejackets_players = [
    ...
    Skater("Kirill Marchenko", 70, 35, 40, 60, 60, powerplay=55,role="2nd Line"),
...
stars_players = [
    ...
    Skater("Roope Hintz", 80, 65, 70, 45, 60, powerplay=70, penaltykill=70,role="2nd Line"),
    Skater("Wyatt Johnston", 60, 60, 60, 60, 40, 60, 50, role="2nd Line"),
    Skater("Jamie Benn", 60, 60, 70, 30, 40, powerplay=60,role="3rd Line"),
    Skater("Logan Stankoven", 20, 65, 60, 60, 80, powerplay=60,role="3rd Line"),
    ...
    Skater("Oskar Back", 20, 60, 40, 60, 50, penaltykill=50,role="4th Line"),
    ...
    Skater("Thomas Harley", 80, 55, 70, 50, 60, powerplay=60, penaltykill=65,role="2nd Pair", position="defense"),
...
redwings_players = [
    ...
    Skater("Marco Kasper", 20, 20, 40, 50, 30, 30,role="4th Line"),
    ...
    Skater("Albert Johansson", 20,20,30,50,60,role="Depth", position="defense"),
]
...
wild_players = [
    ...
    Skater("Matthew Boldy", 70, 55, 70, 60, 45, 70,role="1st Line"),
    Skater("Mats Zuccarello", 60, 80, 60, 45, 60, 70,role="1st Line"),
    Skater("Marco Rossi", 50, 40, 45, 40, 60, 20,role="2nd Line"),
    Skater("Joel Eriksson-Ek", 35, 60, 60, 65, 60, 80, 30,role="1st Line"),
    ...
    Skater("Brock Faber", 60, 65, 40, 45, 65, 50, 30,role="Number 1", position="defense"),
    ...
    Skater("Jake Middleton", 50, 45, 30, 45, 60, penaltykill=35,role="2nd Pair", position="defense"),
    Skater("Zach Bogosian", 30, 45, 45,40, 30, penaltykill=40,role="3rd Pair", position="defense"),
    Skater("Declan Chisholm", 60, 55, 50, 60, 40, 65,role="3rd Pair", position="defense"),
...
canadiens_players = [
    ...
    Skater("Lane Hutson", 40, 70, 80, 20, 55, 65,role="Top Pair", position="defense"),
...
flyers_players = [
    ...
    Skater("Matvei Michkov", 70, 60, 60, 40, 30, 30,role="3rd Line"),
...
penguins_players = [
    ...
    Skater("Blake Lizotte", 40, 60, 45, 65, 55, penaltykill=60,role="4th Line"),
    Skater("Anthony Beauvilier", 20, 45, 40, 40, 50,role="4th Line"),
    Skater("Jesse Puljujarvi", 20, 45, 55, 60, 30,role="4th Line"),
    Skater("Valtteri Puustinen", 30, 80, 50, 65, 35, role="4th Line"),
    Skater("Phil Tomasino", 45, 60, 50, 45, 65, 45, role="4th Line"),
    Skater("Erik Karlsson", 80, 80, 80, 20, 80, 80,role="Number 1", position="defense"),
    Skater("Kris Letang", 70, 60, 60, 30, 50, 60, 80,role="Number 1", position="defense"),
    Skater("Marcus Pettersson", 30, 70, 70, 60, 40, penaltykill=80, role="Top Pair", position="defense"),
    Skater("Ryan Graves", 60, 35, 60, 45, 60, penaltykill=50,role="3rd Pair", position="defense"),
    Skater("Matt Grzelyck", 40, 60, 30, 30, 35,role="3rd Pair", position="defense"),
...
sharks_players = [
    ...
    Skater("Macklin Celebrini", 80, 60, 60, 50, 80, 30,role="1st Line"),
    Skater("Will Smith", 60, 55, 60, 30, 30, 20,  role="4th Line"),
...
blues_players = [
    ...
    Skater("Dylan Holloway", 55, 30, 50, 60, 50,role="4th Line"),
    ...
    Skater("Philip Broberg", 50, 45, 60, 50, 60, penaltykill=60, role="3rd Pair", position="defense"),
...
lightning_players = [
    ...
    Skater("Brandon Hagel", 65, 65, 70, 60, 60, 35, 70,role="1st Line"),
    Skater("Anthony Cirelli", 45, 60, 60, 80, 80, 50, 40,role="2nd Line"),
    Skater("Nicholas Paul", 60, 40, 30, 80, 50, 50,role="2nd Line"),
    ...
    Skater("Gage Goncalves", 30, 20, 35, 60, 40, role="4th Line"),
    ...
    Skater("Darren Raddysh", 60, 40, 40, 55, 60, role="3rd Pair", position="defense"),
    Skater("Emil Lilleberg", 40, 65, 30, 30, 20, penaltykill=35, role="Depth", position="defense"),
    Skater("Nick Perbix", 50, 70, 40, 60, 70,role="3rd Pair", position="defense")
]

leafs_players = [
    Skater("Auston Matthews", 80, 70, 80, 60, 70, 70,role="1st Line"),
    Skater("Mitch Marner", 70, 80, 60, 60, 60, 80, 50, role="1st Line"),
    Skater("William Nylander", 70, 65, 80, 20, 55, 80,role="1st Line"),
    Skater("John Tavares", 30, 60, 70, 60, 40, 80,role="2nd Line"),
    Skater("Matthew Knies", 60, 55, 50, 50, 40, 40,role="3rd Line"),
    Skater("Max Domi", 40, 80, 60, 20, 30, 20,role="3rd Line"),
    Skater("Nicholas Robertson", 65, 50, 35, 50, 60,role="4th Line"),
    Skater("Pontus Holmberg", 50, 60, 30, 60, 60, penaltykill=30,role="4th Line"),
    Skater("Bobby McMann", 70, 30, 40, 55, 30,role="4th Line"),
    Skater("David Kampf", 40, 40, 30, 60, 55, penaltykill=55,role="4th Line"),
    Skater("Max Pacioretty", 40, 45, 60, 30, 30, 60,role="4th Line"),
    Skater("Ryan Reaves", 40, 40, 30, 50, 35,role="4th Line"),
    Skater("Steven Lorentz", 35, 30, 50, 60, 40,role="4th Line"),
    Skater("Connor Dewar", 40, 40, 35, 70, 50, penaltykill=70,role="4th Line"),
    # Skater("Calle Jarnkrok", 60, 45, 50, 50, 60, 35, 40,role="Depth"),
    # Skater("Alex Nylander", 60, 30, 60, 30, 45, 45, role="bench"),
    Skater("Morgan Rielly", 40, 80, 65, 20, 60, 70,role="2nd Pair", position="defense"),
    Skater("Oliver Ekman-Larsson", 50, 60, 55, 40, 50, 35, 70,role="2nd Pair", position="defense"),
    Skater("Jake McCabe", 50, 60, 65, 60, 60, penaltykill=65,role="2nd Pair", position="defense"),
    Skater("Chris Tanev", 50, 50, 50, 80, 60, penaltykill=40,role="2nd Pair", position="defense"),
    Skater("Simon Benoit", 30, 20, 20, 40, 40, penaltykill=40,role="3rd Pair", position="defense"),
    ...
    Skater("Philippe Myers", 30, 30, 55, 50, 40, penaltykill=40, role="Depth", position="defense"),
]
...
utah_players = [
    ...
    Skater("Logan Cooley", 60, 60, 50, 45, 70, 30,role="3rd Line"),
    Skater("Dylan Guenther", 70, 45, 40, 35, 30, 40,role="3rd Line"),
...
canucks_players = [
    ...
    Skater("Conor Garland", 55, 65, 60, 80, 80, 30,role="3rd Line"),
    Skater("Nils Hoglander", 60, 55, 55, 55, 50,role="4th Line"),
    Skater("Dakota Joshua", 55, 45, 55, 45, 60, penaltykill=60,role="4th Line"),
    Skater("Teddy Blueger", 30, 60, 55, 50, 50, penaltykill=60,role="3rd Line"),
    Skater("Danton Heinen", 55, 60, 55, 50, 30, penaltykill=65,role="4th Line"),
    Skater("Pius Suter", 55, 40, 45, 70, 60, 40, 80,role="3rd Line"),
    ...
    Skater("Filip Hronek", 40, 60, 40, 40, 60, 60, 60,role="Top Pair", position="defense"),
    Skater("Carson Soucy", 60, 30, 30, 60, 30, penaltykill=55,role="3rd Pair", position="defense"),
    Skater("Tyler Myers", 20, 60, 20, 40, 20, penaltykill=30,role="2nd Pair", position="defense"),
    ...
    Skater("Noah Juulsen", 30, 40, 30, 45, 40, penaltykill=70,role="Depth", position="defense"),
    Skater("Erik Brannstrom", 20, 55, 60, 55, 45, penaltykill=40,role="Depth", position="defense")
]
...
knights_players = [
    ...
    Skater("Ivan Barbashev", 65, 70, 60, 20, 55, 30,role="3rd Line"),
    Skater("Victor Olofsson", 70, 45, 30, 30, 60, 50,role="4th Line"),
    Skater("Brett Howden", 60, 40, 30, 35, 35, penaltykill=45,role="4th Line"),
    Skater("Alexander Holtz", 60, 40, 30, 30, 35, 30, role="4th Line"),
    Skater("Pavel Dorofeyev", 65, 35, 50, 60, 45, 50,role="3rd Line"),
    Skater("Keegan Kolesar", 45, 55, 50, 50, 40,role="4th Line"),
    Skater("Tanner Pearson", 40, 40, 50, 30, 55,role="4th Line"),
    Skater("Brendan Brisson", 35, 60, 50, 40, 40,role="4th Line"),
    Skater("Jonas Rondbjerg", 20, 50, 20, 60, 45,role="Depth"),
    Skater("Cole Schwindt", 20, 40, 50, 60, 80, role="4th Line"),
    Skater("Nicolas Roy", 35, 60, 60, 60, 30, 55, 50,role="3rd Line"),
    Skater("Alex Pietrangelo", 55, 65, 80, 35, 70, 60, 45,role="Top Pair", position="defense"),
    Skater("Shea Theodore", 60, 80, 65, 30, 60, 60,role="Top Pair", position="defense"),
    ...
    Skater("Nick Hague", 30, 40, 50, 50, 55, penaltykill=50,role="3rd Pair", position="defense"),
    Skater("Kaeden Korczak", 40, 70, 60, 60, 50,role="Depth", position="defense"),
    Skater("Ben Hutton", 50, 50, 35, 60, 60, role="Depth", position="defense"),
    Skater("Zach Whitecloud", 60, 60, 45, 60, 45, penaltykill=40,role="3rd Pair", position="defense")
]
