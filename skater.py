...
avalanche_players = [
    ...
    Skater("Cale Makar", 80, 70, 50, 65, role="Number 1"),
...
stars_players = [
    ...
    Skater("Nils Lundkvist", 45, 50, 50, 30, role="bench")
]
...
wild_players = [
    ...
    Skater("Jared Spurgeon", 60, 50, 65, 85, role="Top Pair"),
...
devils_players = [
    ...
    Skater("Luke Hughes", 65, 35, 60, 30, role="2nd Pair"),
    Skater("Brenden Dillon", 50, 45, 45, 70, role="3rd Pair"),
...
islanders_players = [
    ...
    Skater("Anders Lee", 55, 20, 70, 55, role="2nd Line"),
    Skater("JG Pageau", 35, 60, 55, 60, role="3rd Line"),
    Skater("Pierre Engvall", 50, 50, 70, 70, role="3rd Line"),
    Skater("Casey Cizikas", 35, 30, 30, 60, role="3rd Line"),
    Skater("Julien Gauthier", 50, 30, 35, 30, role="4th Line"),
    Skater("Simon Holmstrom", 65, 30, 20, 65, role="4th Line"),
    Skater("Kyle MacLean", 50, 50, 30, 60, role="4th Line"),
    Skater("Hudson Fasching", 50, 55, 50, 60, role="bench"),
    Skater("Oliver Wahlstrom", 35, 30, 35, 35, role="bench"),
...
penguins_players = [
    ...
    Skater("Erik Karlsson", 70, 90, 90, 20, role="Number 1"),
    Skater("Marcus Pettersson", 20, 70, 65, 70, role="Top Pair"),
    Skater("Kris Letang", 70, 60, 60, 35, role="2nd Pair"),
...
utah_players = [
    ...
    Skater("Dylan Guenther", 60, 45, 35, 40, role="2nd Line"),
