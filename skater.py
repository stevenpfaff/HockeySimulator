...
forwards = {
    ...
    "landeskog": Skater("Gabriel Landeskog", 50, 50, 40, 40),
    ...
    "jiracek": Skater("David Jiracek", 30, 60, 40, 30),
    ...
    "blackwell": Skater("Colin Blackwell", 30, 45, 30, 45),
    ...
    "berggren": Skater("Jonatan Berggren", 40, 40, 40, 30),
    "seider": Skater("Moritz Seider", 50, 60, 30, 60),
    ...
    "jbrown": Skater("Josh Brown", 40, 35, 45, 20),
    ...
    "boqvist": Skater("Adam Boqvist", 65, 35, 60, 20),
    ...
    "lewis": Skater("Trevor Lewis", 30, 35, 20, 60),
    ...
    "ruhwedel": Skater("Chad Ruhwedel", 35, 20, 35, 60),
    ...
    "crookshank": Skater("Angus Crookshank", 40, 40, 40, 35),
    ...
    "lizotte": Skater("Blake Lizotte", 35, 55, 45, 55),
    "nieto": Skater("Matt Nieto", 30, 50, 40, 55),
    ...
    "thrun": Skater("Henry Thrun", 40, 30, 30, 30),
    ...
    "wright": Skater("Shane Wright", 30, 50, 40, 30),
    "stephenson": Skater("Chandler Stephenson", 55, 70, 35, 30),
    "bmeyers": Skater("Ben Meyers", 30, 20, 30, 60),
    ...
    "mahura": Skater("Josh Mahura", 45, 50, 30, 45),
    ...
    "suter": Skater("Ryan Suter", 30, 45, 40, 60),
    ...
    "raddysh": Skater("Darren Raddysh", 55, 35, 35, 60),
    # Maple Leafs
    ...
    "obrien": Skater("Liam O'Brien", 20, 20, 20, 70),
    ...
    "sprong": Skater("Daniel Sprong", 70, 60, 60, 30),
    ...
    "lapierre": Skater("Hendrix Lapierre", 60, 30, 30, 30),
    ...
    "cmiller": Skater("Colin Miller", 60, 50, 30, 45),
