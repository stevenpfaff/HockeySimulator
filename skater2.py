...
kings_players = [
    ...
    Skater("Drew Doughty", 65, 50, 55, 80, 55, 45, 50,role="Number 1", position="defense"),
...
predators_players = [
    ...
    Skater("Spencer Stastney", 60, 35, 65, 50, 60, penaltykill=45,role="Depth", position="defense")
]
...
sharks_players = [
    ...
    Skater("Macklin Celebrini", 60, 45, 60, 45, 70, 30,role="1st Line"),
...
utah_players = [
    ...
    Skater("Sean Durzi", 55, 50, 50, 45, 45, 70, 60,role="2nd Pair", position="defense"),
    Skater("John Marino", 30, 60, 30, 65, 70, penaltykill=45,role="2nd Pair", position="defense"),
]
