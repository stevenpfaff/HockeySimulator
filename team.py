...
edm_forwards = [forwards["mcdavid"], forwards["draisaitl"], forwards["hyman"], forwards["ekane"], forwards["arvidsson"], forwards["nuge"],  forwards["podkolzin"], forwards["perry"], forwards["mcleod"], forwards["ryan"], forwards["brown"], forwards["nurse"], forwards["ekholm"], forwards["bouchard"], forwards["kulak"], forwards["jbrown"], forwards["stecher"], ]
...
nsh_forwards = [forwards["forsberg"], forwards["oreilly"], forwards["novak"], forwards["stamkos"], forwards["marchessault"],forwards["nyquist"], forwards["sissons"], forwards["csmith"], forwards["mccarron"], forwards["jankowski"], forwards["evangelista"], forwards["josi"], forwards["skjei"], forwards["lschenn"], forwards["acarrier"], forwards["fabbro"], forwards["lauzon"]]
