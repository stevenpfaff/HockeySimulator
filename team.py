...
buf_forwards = [forwards["thompson"], forwards["tuch"], forwards["cozens"], forwards["greenway"], forwards["benson"], forwards["quinn"], forwards["kubel"], forwards["peterka"], forwards["krebs"], forwards["lafferty"], forwards["zucker"], forwards["malenstyn"], forwards["dahlin"], forwards["power"], forwards["byram"], forwards["clifton"], forwards["jokiharju"], forwards["bryson"], forwards["samuelsson"]]
...
cbj_forwards = [forwards["jenner"], forwards["marchenko"], forwards["kjohnson"], forwards["kuraly"], forwards["monahan"], forwards["chinakhov"], forwards["olivier"], forwards["danforth"], forwards["fantilli"], forwards["voronkov"], forwards["sillinger"], forwards["werenski"], forwards["severson"], forwards["provorov"], forwards["jjohnson"], forwards["harris"], forwards["gudbranson"]]
...
det_forwards = [forwards["larkin"], forwards["raymond"], forwards["debrincat"], forwards["copp"], forwards["compher"], forwards["tarasenko"], forwards["fischer"], forwards["rasmussen"], forwards["veleno"], forwards["motte"], forwards["pkane"], forwards["watson"], forwards["seider"], forwards["chiarot"], forwards["holl"], forwards["maatta"], forwards["gustafsson"], forwards["petry"]]
edm_forwards = [forwards["mcdavid"], forwards["draisaitl"], forwards["hyman"], forwards["ekane"], forwards["arvidsson"], forwards["nuge"],  forwards["podkolzin"], forwards["perry"], forwards["mcleod"], forwards["ryan"], forwards["skinner"], forwards["brown"], forwards["nurse"], forwards["ekholm"], forwards["bouchard"], forwards["kulak"], forwards["jbrown"], forwards["stecher"], ]
...
teams = {
    ...
    "sj": Team("San Jose Sharks", "SJ", sj_offense, sj_defense, goalies["blackwood"], goalies["askarov"]),
