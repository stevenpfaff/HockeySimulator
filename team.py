...
buf_forwards = [forwards["thompson"], forwards["tuch"], forwards["skinner"], forwards["cozens"], forwards["greenway"], forwards["benson"], forwards["quinn"], forwards["kubel"], forwards["mcleod"], forwards["peterka"], forwards["krebs"], forwards["lafferty"], forwards["zucker"], forwards["dahlin"], forwards["power"], forwards["byram"], forwards["clifton"], forwards["bryson"], forwards["samuelsson"]]
...
nyr_forwards = [forwards["panarin"], forwards["kreider"], forwards["zibanejad"], forwards["rsmith"], forwards["trocheck"], forwards["chytil"], forwards["lafreniere"], forwards["kakko"], forwards["edstrom"], forwards["cuylle"], forwards["carrick"], forwards["rempe"], forwards["vesey"], forwards["fox"], forwards["trouba"], forwards["zjones"], forwards["kmiller"], forwards["ruhwedel"], forwards["lindgren"]]
ott_forwards = [forwards["giroux"], forwards["stuetzle"], forwards["btkachuk"], forwards["batherson"], forwards["pinto"], forwards["greig"], forwards["macewen"], forwards["perron"], forwards["norris"], forwards["amadio"], forwards["gregor"], forwards["crookshank"], forwards["sanderson"], forwards["chabot"],  forwards["zub"], forwards["hamonic"],  forwards["jensen"], forwards["docker"]]
